...
const CompletedComic = (props: IProps) => {
  ...
  return (
    <div>
      ...
      <List
        ...
        dataSource={CompletedComicsData?.comics}
        renderItem={(item) => (
          <List.Item>
            <div
              key={item?.id}
      ...
      >
        <Pagination
          ...
          total={CompletedComicsData?.total_pages * comicsPerPage}
